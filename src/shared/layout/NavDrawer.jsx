...
const socials = [
  {
    label: 'Facebook',
     url: 'https://www.facebook.com/share/1Duyj9kPXF/?mibextid=wwXIfr', 
  ...
  {
    label: 'Instagram',
     url: 'https://www.instagram.com/aceropress', 
  ...
  {
    label: 'TikTok',
    url: 'https://tiktok.com/@acero.press', 
  ...
  {
    label: 'YouTube',
    url: 'https://www.youtube.com/channel/UCPbb5qIUVjBZ2896RW2Ko8Q', 
